...
def index():
    ...
    return render_template("index.html", title = title, tops=top_headlines)


@main.route("/search/<news_id>")
def search(news_id):
    '''
    View function to display the search results
    '''
    
    searched_news = search_news(news_id)
    title = f" Search results for {news_id}"
